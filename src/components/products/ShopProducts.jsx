        ...
        >
          ...
          >
            ...
            <ul className="flex flex-col transition-all duration-500 justify-start items-start gap-2 ">
              <li
                ...
                className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded shadow hover:bg-blue-400 hover:text-white  absolute -left-10 top-6  group-hover:left-5  transition-all duration-300"
              >
                <AiOutlineShoppingCart />
              </li>
              <li
                onClick={() => add_wishlist(p)}
                className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded shadow hover:bg-blue-400 hover:text-white absolute -left-10 top-[70px]  group-hover:left-5  transition-all duration-500"
              >
                <AiFillHeart />
              </li>
              <li
                onClick={() => add_compare(p)}
                className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded shadow hover:bg-blue-400 hover:text-white  absolute -left-10 top-[116px] group-hover:left-5  transition-all duration-700"
              >
                <FaArrowsSpin />
              </li>
              <Link
                to={`/product/details/${p.slug}`}
                className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded shadow hover:bg-blue-400 hover:text-white  absolute -left-10 top-[162px] group-hover:left-5  transition-all duration-1000"
              >
                <FaEye />
              </Link>
            </ul>
          ...
          >
            ...
            <div className="flex justify-start items-center gap-2">
              <span className="text-md  font-bold text-slate-700">Ksh{p.price}</span>
