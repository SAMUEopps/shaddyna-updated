        ...
        <div className="w-[90%] mx-auto pt-5 md-lg:block hidden">
          <div>
            <button
              ...
              className="text-center py-3 px-3 bg-blue-400 text-white"
            >
              <FaList />
            </button>
          </div>
              ...
              <div className="py-5 text-slate-600 ">
                <Link
                  ...
                  className={`dashboard-link pl-7 ${
                    pathname === "/dashboard" ? "border-r-2 bg-blue-100 border-blue-500" : ""
                  }`}
                >
                ...
                <Link
                  ...
                  className={`dashboard-link  pl-7 ${
                    pathname === "/dashboard/my-orders" ? "border-r-2 bg-blue-100 border-blue-500" : ""
                  }`}
                >
                  <span className="text-xl">
                    <MdAmpStories />
                ...
                <Link
                  ...
                  className={`dashboard-link pl-7  ${
                    pathname === "/dashboard/my-compare" ? "border-r-2 bg-blue-100 border-blue-500" : ""
                  }`}
                >
                  <span className="text-xl">
                    <MdCompare />
                ...
                <Link
                  ...
                  className={`dashboard-link pl-7 ${
                    pathname === "/dashboard/my-wishlist" ? "border-r-2 bg-blue-100 border-blue-500" : ""
                  }`}
                >
                  <span className="text-xl">
                ...
                <Link
                  ...
                  className={`dashboard-link pl-7 ${
                    pathname === "/dashboard/edit-profile" ? "border-r-2 bg-blue-100 border-blue-500" : ""
                  }`}
                >
                  <span className="text-xl">
                    <FaUserPen />
                ...
                <Link
                  ...
                  className={`dashboard-link pl-7 ${
                    pathname === "/dashboard/change-password"
                      ? "border-r-2 bg-blue-100 border-blue-500"
                      : ""
                  }`}
                >
                  <span className="text-xl ">
