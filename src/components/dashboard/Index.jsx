  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 md:grid-cols-1 md-lg:gap-4 gap-8  font-medium">
        <div className="flex justify-center items-center  shadow-md p-5 bg-green-400 rounded-md gap-5">
        ...
        <div className="flex justify-center items-center p-5 bg-pink-400 rounded-md gap-5">
        ...
        <div className="flex justify-center items-center p-5 bg-blue-400 rounded-md gap-5">
        ...
        <div className="pt-4 shadow">
          <div className="relative overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500">
              <thead className="text-xs font-medium text-gray-50 uppercase bg-blue-400">
                <tr>
              ...
              <tbody>
                {recentOrders.map((o, i) => (
                  <tr key={i} className="bg-blue-100/50 border-b border-slate-50  ">
