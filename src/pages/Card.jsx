...
const Card = () => {
  ...
  const { card_products, successMessage, price, buy_product_item, shipping_fee, outofstock_products } =
  ...
  return (
    <div>
      <Headers />
      <PageHeader title="shaddyna" category="Card" />
      <section className="bg-[#eeeeee]">
        <div className="w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90] mx-auto py-16">
          {card_products.length > 0 || outofstock_products.length > 0 ? (
                    ...
                    {card_products.map((p, i) => (
                      <div className="flex bg-white p-4 flex-col gap-2 ">
                        <div className="flex justify-start items-center">
                          <h2 className="text-md text-slate-600 font-medium">{p.shopName}</h2>
                        </div>
                        {p.products.map((pt, i) => (
                          <div className="w-full flex flex-wrap  ">
                            <div className="flex sm:w-full gap-2 w-7/12">
                              <div className="flex gap-2 justify-start items-center">
                                <img
                                  className="w-[80px] h-[80px] shadow-md"
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                ...
                                <button
                                  ...
                                  className="px-5 py-[3px] bg-blue-400 text-white"
                                >
                                  Delete
                                </button>
                              </div>
                          ...
                          {outofstock_products.map((p, i) => (
                            <div key={i} className="w-full flex flex-wrap">
                              ...
                              <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                ...
                                <div className="flex gap-2 flex-col">
                                  <div className="flex bg-gray-500 text-white h-[30px] justify-center items-center text-xl">
                                    <div
                                    ...
                                    <div
                                      onClick={() => dec(p.quantity, p.products[0].stock, p._id)}
                                      className="px-3 cursor-pointer"
                                    >
                                      +
                                    </div>
                ...
                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                  {card_products.length > 0 && (
                    <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span>Total</span>
                        <span className="text-lg text-blue-500">Ksh{price + shipping_fee}</span>
                      </div>
                      <button
                        onClick={redirect}
                        className="px-5 py-[6px] rounded-sm hover:shadow-blue-400/20 hover:shadow-lg bg-blue-400 text-sm text-white uppercase"
                      >
            ...
            <div>
              <Link className="px-4 py-1 bg-blue-400 text-white" to="/shops">
                Shop Now
              </Link>
            </div>
          )}
