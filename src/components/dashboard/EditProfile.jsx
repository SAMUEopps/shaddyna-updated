      ...
      {edit ? (
          ...
          <div className="max-w-md mx-auto bg-slate-50 p-3">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-between gap-2 items-center">
                <button
                  type="submit"
                  className="bg-blue-400 font-medium text-white px-4 py-2 rounded hover:bg-pink-400"
                >
                  Save Changes
                </button>
                <button
                  ...
                  type="button"
                  className="bg-pink-400 font-medium text-white px-4 py-2 rounded hover:bg-blue-400"
                >
                  See Profile
                </button>
              </div>
        ...
        <div className="pl-5 mx-auto  ">
          ...
          <div className=" bg-slate-50 p-7 shadow relative">
            <button
              onClick={() => setEdit(!edit)}
              className="absolute top-2 right-2 bg-blue-400 hover:bg-pink-400 px-5 py-1.5 font-medium text-white rounded"
            >
              Edit Profile
            </button>
